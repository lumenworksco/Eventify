...
const translations: Record<Locale, Translations> = {
  en: {
    ...
    'home.browseTitle': 'Browse & filter events',
    'home.browseDesc': 'Search by city, type or artist to find the perfect event.',
    'home.discoverTitle': 'Explore venues',
    'home.discoverDesc': 'Discover venue details, locations and upcoming schedules.',
    'home.addTitle': 'Get tickets',
    'home.addDesc': 'Purchase tickets directly and manage them from your profile.',
    'home.badgeFree': 'Free',
    ...
    'events.type': 'Type',
    'events.searchPlaceholder': 'Search events, artists, venues...',
    'events.eventsFound': '{count} event found',
    'events.eventsFoundPlural': '{count} events found',
    'events.clearFilters': 'Clear filters',
    'events.noMatch': 'No events match your search',
    'events.noMatchHint': 'Try adjusting your filters or search terms',
  ...
  fr: {
    ...
    'home.browseTitle': 'Parcourir et filtrer les événements',
    'home.browseDesc': 'Recherchez par ville, type ou artiste pour trouver l\'événement parfait.',
    'home.discoverTitle': 'Explorer les lieux',
    'home.discoverDesc': 'Découvrez les détails des lieux, les adresses et les programmes à venir.',
    'home.addTitle': 'Obtenir des billets',
    'home.addDesc': 'Achetez des billets directement et gérez-les depuis votre profil.',
    ...
    'events.type': 'Type',
    'events.searchPlaceholder': 'Rechercher des événements, artistes, lieux...',
    'events.eventsFound': '{count} événement trouvé',
    'events.eventsFoundPlural': '{count} événements trouvés',
    'events.clearFilters': 'Effacer les filtres',
    'events.noMatch': 'Aucun événement ne correspond à votre recherche',
    'events.noMatchHint': 'Essayez de modifier vos filtres ou vos termes de recherche',
  ...
  de: {
    ...
    'home.browseTitle': 'Veranstaltungen durchsuchen & filtern',
    'home.browseDesc': 'Suchen Sie nach Stadt, Typ oder Künstler, um die perfekte Veranstaltung zu finden.',
    'home.discoverTitle': 'Veranstaltungsorte erkunden',
    'home.discoverDesc': 'Entdecken Sie Details, Standorte und kommende Programme der Veranstaltungsorte.',
    'home.addTitle': 'Tickets kaufen',
    'home.addDesc': 'Kaufen Sie Tickets direkt und verwalten Sie diese über Ihr Profil.',
    ...
    'events.type': 'Typ',
    'events.searchPlaceholder': 'Veranstaltungen, Künstler, Veranstaltungsorte suchen...',
    'events.eventsFound': '{count} Veranstaltung gefunden',
    'events.eventsFoundPlural': '{count} Veranstaltungen gefunden',
    'events.clearFilters': 'Filter zurücksetzen',
    'events.noMatch': 'Keine Veranstaltungen entsprechen Ihrer Suche',
    'events.noMatchHint': 'Versuchen Sie, Ihre Filter oder Suchbegriffe anzupassen',
